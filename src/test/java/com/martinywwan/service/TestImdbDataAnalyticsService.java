...
public class TestImdbDataAnalyticsService {
    ...
    public void testGetTop10Titles() {
        ...
        List<Row> expectedResult = Arrays.asList(
                RowFactory.create("tt0000004", 9.0, 1000, 14.975041597337771, 1),
                RowFactory.create("tt0000005", 9.5, 505, 7.98252911813644, 2),
                RowFactory.create("tt0000001", 5.0, 600, 4.9916805324459235, 3),
                RowFactory.create("tt0000002", 4.0, 500, 3.327787021630616, 4)
        );
        ...
        expectedSchema = expectedSchema.add("titleRanking", IntegerType, false);
